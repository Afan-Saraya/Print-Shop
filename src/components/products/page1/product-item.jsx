...
const ProductItem = ({ product, prdCenter = false,primary_style=false }) => {
  ...
  return (
    ...
    >
      <div className="tp-product-thumb-3 mb-15 fix p-relative z-index-1" style={{ width: "100%", paddingBottom: "100%", position: "relative", overflow: "hidden" }}>
