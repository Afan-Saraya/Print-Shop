...
export const feature_data = [
  {
    icon: <Delivery />,
    title: 'Besplatan Editor',
    subtitle: 'Kreiraj dizajn bez dodatnih troškova'
  },
  {
    icon: <Refund />,
    title: 'Brza Dostava',
    subtitle: 'Dostava u Sarajevu za 2-3 dana'
  },
  {
    icon: <Discount />,
    title: 'Igrice & Pokloni',
    subtitle: 'Osvoji besplatne personalizovane poklone'
  },
  {
    icon: <Support />,
    title: 'Podrška 24/7',
    subtitle: 'Pomoć pri kreiranju vašeg dizajna'
  },
]
