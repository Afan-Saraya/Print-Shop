...
// slider data 
const slider_data = [
  { subtitle: 'Personaliziraj svoje', title: 'Majice', img: slider_img_1 },
  { subtitle: 'Personaliziraj svoje', title: 'Šolje', img: slider_img_2 },
  { subtitle: 'Personaliziraj svoje', title: 'Kese i Cekere', img: slider_img_3 },
  { subtitle: 'Personaliziraj svoje', title: 'Olovke', img: slider_img_4 },
]
        ...
        <Slider {...main_slider_setting} asNavFor={slider2} ref={(slider) => setSlider1(slider)} className="tp-slider-active-4 khaki-bg">
          {slider_data.map((item, i) => (
            <div key={i} className="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                ...
                <Image src={item.img} alt="slider img" className="tp-slider-img" />
