      ...
      <div className="tp-product-details-tab-nav tp-tab">
        <nav>
          <div className="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
            <NavItem active={true} linkRef={activeRef} id="desc" title="Opis" />
            <NavItem id="additional" title="Dodatne informacije" />
            <NavItem id="review" title={`Recenzije (${reviews.length})`} />
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="tp-product-details-review-statics">
                    ...
                    <div className="tp-product-details-review-list pr-110">
                      <h3 className="tp-product-details-review-title">Ocjena i recenzija</h3>
                ...
                <div className="col-lg-6">
                  <div className="tp-product-details-review-form">
                    <h3 className="tp-product-details-review-form-title">Recenzirajte ovaj proizvod</h3>
                    <p>Vaša email adresa neće biti objavljena. Obavezna polja su označena sa *</p>
                    {/* form start */}
