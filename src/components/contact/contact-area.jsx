            ...
            <div className="row">
              <div className="col-xl-9 col-lg-8">
                <div className="tp-contact-wrapper">
                  <h3 className="tp-contact-title">Pošalji Poruku</h3>
                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:info@giftshop.ba">info@giftshop.ba</a>
                      </p>
                      <p data-info="phone">
                  ...
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p>
                        <a
                          href="https://www.google.com/maps/place/Sarajevo,+Bosnia+and+Herzegovina/"
                          target="_blank"
                        >
                          Sarajevo <br /> Bosna i Hercegovina
                        </a>
                      </p>
                    </div>
                  </div>
