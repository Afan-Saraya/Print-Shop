            ...
            <div className="row gx-0">
              <div className="col-xl-6 col-lg-6">
                <div className="tp-collection-thumb-wrapper-4 p-relative fix z-index-1" >
                  ...
                  <span className="tp-collection-thumb-info-4">PERSONALIZOVANI POKLONI SA PRINTOM</span>
                  ...
                  <div className="tp-collection-hotspot-item tp-collection-hotspot-1">
                    ...
                    <div className="tp-collection-hotspot-content">
                      <h3 className="tp-collection-hotspot-title">Editor za Dizajn</h3>
                      <p>Dodaj slike, tekst i odaberi poziciju na proizvodu u realnom vremenu.</p>
                    </div>
                  </div>
                  ...
                  <div className="tp-collection-hotspot-item tp-collection-hotspot-2">
                    ...
                    <div className="tp-collection-hotspot-content on-top">
                      <h3 className="tp-collection-hotspot-title">Hotspot Igrice</h3>
                      <p>Igraj igrice u Sarajevu i osvoji besplatne personalizovane poklone!</p>
                    </div>
                  </div>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-xl-6 col-lg-8">
                      <div className="tp-collection-item-4 text-center">
                        <span className="tp-collection-subtitle-4">KREIRAJ SVOJ POKLON</span>
