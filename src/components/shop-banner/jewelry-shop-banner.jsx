            ...
            <div className="col-xl-6 col-lg-7 col-12">
              <div className="row">
                <div className="col-12">
                  <BannerItem cls="mb-25" bg_clr="F3F7FF" bg={banner_bg_1} content="Mogućnosti" 
                  title={<>Besplatan Editor <br /> za Dizajn</>} isBtn={true} />
                </div>
                <div className="col-6">
                <BannerItem cls="has-green sm-banner" bg_clr="F0F6EF" bg={banner_bg_2} content="Igrice" title="Osvoji Poklone" />
  
                </div>
                <div className="col-6">
                <BannerItem cls="has-brown sm-banner" bg_clr="F8F1E6" bg={banner_bg_3} content="Brzo" title="Dostava u Sarajevu" />
                </div>
                <div className="col-12">
                  <div className="tp-banner-full tp-banner-full-height fix p-relative z-index-1">
                    ...
                    <div className="tp-banner-full-content">
                      ...
                      <h3 className="tp-banner-full-title">
                        <Link href="/shop">Kreiraj Svoj <br /> Poklon Sada</Link>
                      </h3>
                      <div className="tp-banner-full-btn">
                        <Link href="/shop" className="tp-btn tp-btn-border">
                          Počni Dizajniranje{" "}<ArrowRightLong/>
                        </Link>
                      </div>
                    </div>
                  </div>
