              ...
              <div className="row">
                  ...
                  <div className="tp-footer-widget footer-col-4-2 mb-50">
                    ...
                    <div className="tp-footer-widget-content">
                      <ul>
                        ...
                        <li><a href="/wishlist">Omiljeni</a></li>
                        <li><a href="/cart">Korpa</a></li>
                        <li><a href="/profile">Istorija Narudžbi</a></li>
                        <li><a href="/profile">Povraćaji</a></li>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-7">
                  <div className="tp-footer-widget footer-col-4-4 mb-50">
                    <h4 className="tp-footer-widget-title">Pretplati se.</h4>
                    <div className="tp-footer-widget-content">
                      <div className="tp-footer-subscribe">
                        <p>Budi prvi koji će saznati o novim proizvodima i ponudama</p>
                        <div className="tp-footer-subscribe-form mb-30">
                          <form action="#">
                            <div className="tp-footer-subscribe-input">
                              <input type="email" placeholder="Unesi Tvoju Email Adresu" />
                              <button type="submit">Pretplati se</button>
                            </div>
                          </form>
                        </div>
                        <div className="tp-footer-social-4 tp-footer-social">
                          <h4 className="tp-footer-social-title-4">Prati Nas</h4>
