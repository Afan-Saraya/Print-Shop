...
import logo_dark from '@assets/img/logo/logo.png';
...
const HeaderFour = () => {
  ...
  return (
    <>
      <header>
        <div id="header-sticky" className="tp-header-area tp-header-style-transparent-white tp-header-sticky tp-header-transparent has-dark-logo tp-header-height">
                ...
                <div className="col-xl-2 col-lg-2 col-6">
                  <div className="tp-header-action d-flex align-items-center justify-content-end ml-50">
                    ...
                    <div className="tp-header-action-item d-none d-sm-block">
                      <button disabled type="button" className="tp-header-action-btn cartmini-open-btn" style={{ opacity: 0.5, cursor: 'not-allowed' }}>
                        <CartTwo />
                        <span className="tp-header-action-badge">0</span>
                      </button>
                    </div>
                    <div className="tp-header-action-item d-none d-sm-block">
                      <button disabled type="button" className="tp-header-action-btn" style={{ opacity: 0.5, cursor: 'not-allowed' }}>
                        <Wishlist />
                        <span className="tp-header-action-badge">0</span>
                      </button>
                    </div>
